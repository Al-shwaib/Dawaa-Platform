...
- **Google Maps API**: تضمين الخرائط التفاعلية في التطبيق والموقع.
...
- **خطوات عملية استخراج البيانات بتقنية التعرف الضوئي على الأحرف (OCR):**
  ![خطوات استخراج البيانات OCR](assets/ocr-data-extraction-steps.png)

- **خطوات عملية التعرف على الدواء:**
  ![خطوات التعرف على الدواء](assets/drug-recognition-steps.png)

- **تدفق البيانات في المخطط البيئي:**
  ![تدفق البيانات في المخطط البيئي](assets/environment-data-flow.png)

- **تدفق البيانات في المخطط الصفري:**
  ![تدفق البيانات في المخطط الصفري](assets/zero-diagram-data-flow.png)

- **الكيانات المتفاعلة في مخطط ERD:**
  ![الكيانات المتفاعلة ERD](assets/erd-entities.svg)

- **مخطط Schema يبين العلاقات بين سمات الكيانات:**
  ![مخطط Schema](assets/schema-attributes-relations.svg)

- **مخطط بيرت التكراري يوضح المعدل الزمني لتنفيذ متطلبات المشروع:**
  ![مخطط بيرت التكراري](assets/pert-timeline.png)

- **جزء من مخطط هيكلة الاستخدام:**
...
## فريق العمل 👨‍💻
- عبد القدوس محمد عبد الواحد الشويب
- عبد الله محمد قاسم عبد الكريم
- لؤي أحمد لطف قاسم الخلي
- عبده محمد أحمد علي الورد
- عبد العزيز بن محمد بن عبده دحان
- محمد عبد الله عمر الحضرمي
